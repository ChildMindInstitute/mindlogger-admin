...
describe('ItemSettingsController', () => {
  ...
  test.each`
    ...
    ${ItemConfigurationSettings.HasScores}               | ${'activities.0.items.0.responseValues.scores'}                             | ${mockedSliderWithNoScores}                | ${undefined}                                              | ${[2, 3, 4, 5]}                                                | ${'opting in scores for Slider sets scores in responseValues'}
