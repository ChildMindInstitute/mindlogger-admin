...
describe('ItemSettingsController', () => {
  ...
  test.each`
    ...
    ${ItemConfigurationSettings.HasScores}               | ${'activities.0.items.0.responseValues.scores'}                             | ${mockedSliderFormValues}                  | ${undefined}                                              | ${[1, 2, 3, 4]}                                           | ${'opting in scores for Slider sets scores in responseValues'}
    ...
    ${ItemConfigurationSettings.HasScores}               | ${'activities.0.items.0.responseValues.options'}                            | ${mockedSingleSelectWithoutScores}         | ${mockedSingleSelectWithoutScores.responseValues.options} | ${mockedSingleSelectFormValues.responseValues.options}    | ${'opting in scores for Slider sets scores in responseValues'}
    ${ItemConfigurationSettings.HasScores}               | ${'activities.0.items.0.responseValues.options'}                            | ${mockedSingleSelectFormValues}            | ${mockedSingleSelectFormValues.responseValues.options}    | ${mockedSingleSelectWithoutScores.responseValues.options} | ${'opting out scores for Slider sets scores as undefined in responseValues'}
