...
export const DEFAULT_SLIDER_ROWS_SCORE = createArray(DEFAULT_SLIDER_MAX_VALUE, (i: number) => i + 1);
...
export const SELECTION_OPTIONS_COLOR_PALETTE = [
  ...
  {
    name: 'palette4',
    colors: ['#112f45', '#c53a32', '#e78431', '#ec8a33', '#f4b941', '#e9e1bc', '#9bc8e3', '#4d9cb9', '#577590'],
  },
  {
    name: 'palette5',
    colors: ['#320a17', '#611214', '#901c16', '#bf281b', '#ca4021', '#d7652a', '#e69035', '#eea63c', '#f5bc42'],
  },
  {
    name: 'palette6',
    colors: ['#ee8132', '#ef8d34', '#f19937', '#f2a53b', '#f3ad3d', '#f4b940', '#f6c443', '#f8d147', '#f9dd4b'],
  },
  {
    name: 'palette7',
    colors: ['#007f5f', '#2b9348', '#55a630', '#8cb63d', '#b1ca40', '#c3d043', '#d5d646', '#ddde49', '#ee5'],
  },
  {
    name: 'palette8',
    colors: ['#6a1cb1', '#6238bc', '#5e62c7', '#608fd3', '#66a7d9', '#6bbddf', '#78ccde', '#85dcde', '#93ecdd'],
  },
  {
    name: 'palette9',
    colors: ['#284e74', '#32608d', '#38749b', '#4088a9', '#559ea3', '#6db49b', '#89c597', '#a7d694', '#bee296'],
  },
  {
    name: 'palette10',
    colors: ['#222529', '#353a3f', '#4a5056', '#6e757c', '#aeb5bc', '#cfd4d9', '#dfe2e6', '#eaecef', '#f8f9fa'],
  },
];
