...
export const UnsupportedItemResponse = ({ itemType, 'data-testid': dataTestid }: UnsupportedItemResponseProps) => {
  ...
  return (
    <StyledItem data-testid={dataTestid}>
      ...
      <StyledBodyLarge color={variables.palette.outline}>
        {t(itemType === ItemResponseType.Message ? 'messageDoesNotRequireResponse' : 'unsupportedResponseItem')}
      </StyledBodyLarge>
    </StyledItem>
  );
};
