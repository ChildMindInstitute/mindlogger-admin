...
describe('getSliderOptions', () => {
  test.each`
    ...
    ${0}     | ${3}     | ${'slider1'} | ${[{ id: 'slider1-0', text: 0, value: 0 }, { id: 'slider1-1', text: 1, value: 1 }, { id: 'slider1-2', text: 2, value: 2 }, { id: 'slider1-3', text: 3, value: 3 }]} | ${'should create slider options [0, 3]'}
    ${1}     | ${1}     | ${'slider2'} | ${[{ id: 'slider2-1', text: 1, value: 1 }]}                                                                                                                         | ${'should create slider options for a single value'}
