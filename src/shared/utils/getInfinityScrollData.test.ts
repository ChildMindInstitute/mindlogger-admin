...
describe('getInfinityScrollData', () => {
  ...
  test.each`
    action    | totalSize | listSize | limit | isFetching | expectedCalls | expectedArgument | description
  ...
  `(
    '$description',
    async ({ action, totalSize, listSize, limit, isFetching, expectedCalls, expectedArgument }) => {
