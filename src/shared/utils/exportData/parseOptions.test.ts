...
describe('parseOptions', () => {
  ...
  test.each`
    ...
    ${ItemResponseType.SingleSelection}         | ${single}           | ${'Opt1: 1 (score: 4), Opt2: 2 (score: 2)'}                                                               | ${'single'}
    ${ItemResponseType.MultipleSelection}       | ${multi}            | ${'Opt1: 1 (score: 2), Opt2: 2 (score: 1)'}                                                               | ${'multi'}
    ${ItemResponseType.Slider}                  | ${slider}           | ${'0: 0 (score: 1), 1: 1 (score: 2), 2: 2 (score: 3), 3: 3 (score: 4), 4: 4 (score: 5), 5: 5 (score: 6)'} | ${'slider'}
