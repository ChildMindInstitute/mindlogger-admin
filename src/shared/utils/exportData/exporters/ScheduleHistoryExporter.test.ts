...
describe('ScheduleHistoryExporter', () => {
  ...
  describe('generateExportData', () => {
    ...
    it('individual schedule participant is linked to default schedule in new applet version', async () => {
      ...
      expect(data).toEqual([
        // This entry shouldn't be here. Remove when the ticket below is fixed
        // https://mindlogger.atlassian.net/browse/M2-9106
        expect.objectContaining({
