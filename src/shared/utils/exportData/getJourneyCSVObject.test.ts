...
const decryptedSingleSelection = {
  ...
  sourceSubjectId: '50698c64-88fa-4e75-af91-0e51866641fd',
  sourceSecretId: null,
  sourceUserNickname: 'Mock source user',
  sourceUserTag: 'Mock Tag',
  targetSubjectId: 'dc650dc0-d74a-47f1-b3f9-20a0b1cbac94',
  targetSecretId: null,
