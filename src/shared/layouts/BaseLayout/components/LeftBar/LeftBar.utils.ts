...
// The workspace to open on, given what the user last chose and what they can actually reach. One
// missing from the list belongs to whoever used this browser before them, so it is dropped.
